...
{
	var fns = [
        this.createVertexTemplateEntry('shape=process;whiteSpace=wrap;html=1;', 120, 60, '', '变量声明', null, null, 'process task'),
 		...
 		this.createVertexTemplateEntry('ellipse;whiteSpace=wrap;html=1;', 60, 60, '', '状态', null, null, 'oval circle state'),
	 	...
	 	this.createVertexTemplateEntry('ellipse;shape=doubleEllipse;whiteSpace=wrap;html=1;', 60, 60, '', '终止状态', null, null, 'oval cirlce start end state double')
